...
public class NurseInfo {
    ...
    @Generated(hash = 963237371)
    public NurseInfo(Long id, String schEnDateTime, String schStDateTime,
            String status, String userId, String userCode, String userName,
            String groupDesc, String groupId, String hospitalRowId, String linkLoc,
            String locDesc, String locId, String wardId) {
        this.id = id;
