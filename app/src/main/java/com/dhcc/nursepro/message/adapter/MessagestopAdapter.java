 ...
 * @date 2018/9/13
 */
public class MessagestopAdapter extends BaseQuickAdapter<MessageBean.StopListBean, BaseViewHolder> {


    public MessagestopAdapter(@Nullable List<MessageBean.StopListBean> data) {
        super(R.layout.item_message, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, MessageBean.StopListBean item) {
