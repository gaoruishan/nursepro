 ...
 * @date 2018/9/13
 */
public class MessageAbnormalAdapter extends BaseQuickAdapter<MessageBean.AbnormalPatListBean,BaseViewHolder> {


    public MessageAbnormalAdapter(@Nullable List<MessageBean.AbnormalPatListBean> data) {
        super(R.layout.item_message, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, MessageBean.AbnormalPatListBean item) {
