...
public class AllTourListBean {
    ...
    private List<TourDataListBeanX> tourDataList;
    ...
    public List<TourDataListBeanX> getTourDataList() {
        return tourDataList;
    }

    public void setTourDataList(List<TourDataListBeanX> tourDataList) {
    ...
    public static class TourDataListBeanX {
        /**
         * IntTime : 11:00
         * tourDataList : [{"DHCNurTourDate":"2019-05-09","DHCNurTourTime":"10:14:00","DHCNurTourUser":"护士01","DetailDR":"40","TourType":"Infusion","careLevelDesc":"","tourTypeCode":"Infusion","tourTypeDesc":"输液巡视"}]
         */

        private String IntTime;
        private List<TourDataListBean> tourDataList;
        ...
        public List<TourDataListBean> getTourDataList() {
            return tourDataList;
        }

        public void setTourDataList(List<TourDataListBean> tourDataList) {
            this.tourDataList = tourDataList;
        }

        public static class TourDataListBean {
            /**
             * DHCNurTourDate : 2019-05-09
             * DHCNurTourTime : 10:14:00
             * DHCNurTourUser : 护士01
             * DetailDR : 40
             * TourType : Infusion
             * careLevelDesc :
