 ...
 * Time:15:58
 */
public class NurTourTypeAdapter extends BaseQuickAdapter<GradeTourListBean.LeftFilterBean, BaseViewHolder> {

    private int selectItem;

    public NurTourTypeAdapter(@Nullable List<GradeTourListBean.LeftFilterBean> data) {
