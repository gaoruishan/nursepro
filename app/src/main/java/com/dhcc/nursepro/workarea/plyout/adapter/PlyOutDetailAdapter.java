...
public class PlyOutDetailAdapter extends BaseQuickAdapter<PlyOutDetailBean.DetailListBean, BaseViewHolder>{

    private String FlagNo;

    public PlyOutDetailAdapter(@Nullable List<PlyOutDetailBean.DetailListBean> data) {
        super(R.layout.item_addlabout, data);
    }
    @Override
    protected void convert(BaseViewHolder helper, PlyOutDetailBean.DetailListBean item) {
