...
public class NurRecordModelListAdapter extends BaseQuickAdapter<NurRecordBean.ModelListBean, BaseViewHolder>{
    private Context context ;

    public NurRecordModelListAdapter(@Nullable List<NurRecordBean.ModelListBean> data, Context context) {
