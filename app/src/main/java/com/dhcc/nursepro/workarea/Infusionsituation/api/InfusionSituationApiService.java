 ...
 *
 * @author DevLix126
 * created at 2021/6/30 10:02
 */
public class InfusionSituationApiService extends NurseAPI {
    
    
    public static void GetInfusionByWard(HashMap<String, String> map, String method, final ServiceCallBack callback) {
    ...
    public static void GetInfusionDetailByWard(HashMap<String, String> map, String method, final ServiceCallBack callback) {
        WebServiceUtils.callWebService(method, map, new WebServiceUtils.WebServiceCallBack() {
            @Override
            public void callBack(String result) {
                callback.onResult(result);
