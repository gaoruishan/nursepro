package com.dhcc.nursepro.workarea.milkloopsystem_wenling.milkcoldstorage;
...
import com.dhcc.nursepro.workarea.milkloopsystem_wenling.adapter.MilkColdScanedAdapter;
...
public class MilkColdstorageFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateViewByYM(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_milk_wl_coldstorage, container, false);
    }
