...
import com.dhcc.nursepro.workarea.Infusionsituation.adapter.OrderExecuteOrderDialogAdapter;
import com.dhcc.nursepro.workarea.Infusionsituation.bean.ScanResultBean;

import java.util.ArrayList;
import java.util.List;
/**
 * InfusionOperateDialog
 * 
 *
 * @author DevLix126
 * created at 2021/6/30 11:15
 */
public class InfusionOperateDialog extends Dialog {
    ...
    public InfusionOperateDialog(Context context) {
