 ...
 * Time:10:09
 */
public class DocOrderListPriorityAdapter extends BaseQuickAdapter<DocOrderListBean.OrdPriorityBean, BaseViewHolder> {

    private int selectItem;

    public DocOrderListPriorityAdapter(@Nullable List<DocOrderListBean.OrdPriorityBean> data) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, DocOrderListBean.OrdPriorityBean item) {
