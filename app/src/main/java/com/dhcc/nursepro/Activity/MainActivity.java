...
//    private RelativeLayout loginLayout;
    ...
    public void switchMainTab(int targetIndex)
    {
        ...
        if (targetIndex == TAB_WORKAREA)
        {
            ...
            rbWorkarea.setTextColor(getResources().getColor(R.color.bottom_item_text_selected_color));

            rbMessage.setTextColor(getResources().getColor(R.color.bottom_item_text_unselected_color));
            rbSetting.setTextColor(getResources().getColor(R.color.bottom_item_text_unselected_color));
        ...
        else if(targetIndex == TAB_MESSAGE)
        {
            ...
            rbWorkarea.setTextColor(getResources().getColor(R.color.bottom_item_text_unselected_color));
            rbMessage.setTextColor(getResources().getColor(R.color.bottom_item_text_selected_color));
            rbSetting.setTextColor(getResources().getColor(R.color.bottom_item_text_unselected_color));
        ...
        else
        {
            ...
            rbWorkarea.setTextColor(getResources().getColor(R.color.bottom_item_text_unselected_color));
            rbMessage.setTextColor(getResources().getColor(R.color.bottom_item_text_unselected_color));
            rbSetting.setTextColor(getResources().getColor(R.color.bottom_item_text_selected_color));
