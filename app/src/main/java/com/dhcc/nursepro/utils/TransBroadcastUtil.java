...
public class TransBroadcastUtil {
    ...
    private static List<BroadCastListBean.BroadcastListBean> broadcastList;
    ...
    public static void setScanActionList(List<BroadCastListBean.BroadcastListBean> broadcastListBeans) {
