...
public class BaseActivity extends AppCompatActivity
    ...
    protected BaseFullLoadingView onCreateFullLoadingView() {
        BaseFullLoadingView fullLoadingView = (BaseFullLoadingView) LayoutInflater.from(NApplication.getApp())
    ...
    protected BaseTopLoadingView onCreateTopLoadingView() {
        BaseTopLoadingView topLoadingView = (BaseTopLoadingView) LayoutInflater.from(NApplication.getApp())
    ...
    protected BaseBottomLoadingView onCreateBottomLoadingView() {
        BaseBottomLoadingView bottomLoadingView = (BaseBottomLoadingView) LayoutInflater.from(NApplication.getApp())
    ...
    private void showRequestPermissionDialog(
        ...
        new AlertDialog.Builder(this)
                .setCancelable(true)
                .setMessage(message)
                .setPositiveButton(getString(R.string.next), okListener)
                .create()
                .show();
    }
