...
public class ScannerInterface {
  ...
  public ScannerInterface(Context paramContext) { this.mContext = paramContext; }
  
  public void SetErrorBroadCast(boolean paramBoolean) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.FAILUREBROADCAST");
      intent.putExtra("android.intent.action.FAILUREBROADCAST", paramBoolean);
  ...
  public void addPrefix(String paramString) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.PREFIX");
      intent.putExtra("android.intent.action.PREFIX", paramString);
      this.mContext.sendBroadcast(intent);
    } 
  }
  
  public void addSuffix(String paramString) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.SUFFIX");
      intent.putExtra("android.intent.action.SUFFIX", paramString);
      this.mContext.sendBroadcast(intent);
    } 
  }
  ...
  public void continceScan(boolean paramBoolean) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.BARCODECONTINUCESCAN");
      intent.putExtra("android.intent.action.BARCODECONTINUCESCAN", paramBoolean);
      this.mContext.sendBroadcast(intent);
    } 
  }
  
  public void enableAddKeyValue(int paramInt) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.TERMINATOR");
      intent.putExtra("android.intent.TERMINATOR", paramInt);
      this.mContext.sendBroadcast(intent);
    } 
  }
  
  public void enableFailurePlayBeep(boolean paramBoolean) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.FAILUREBEEP");
      intent.putExtra("android.intent.action.FAILUREBEEP", paramBoolean);
      this.mContext.sendBroadcast(intent);
    } 
  }
  
  public void enablePlayBeep(boolean paramBoolean) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.BEEP");
      intent.putExtra("android.intent.action.BEEP", paramBoolean);
      this.mContext.sendBroadcast(intent);
    } 
  }
  
  public void enablePlayVibrate(boolean paramBoolean) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.VIBRATE");
      intent.putExtra("android.intent.action.VIBRATE", paramBoolean);
      this.mContext.sendBroadcast(intent);
    } 
  }
  
  public void filterCharacter(String paramString) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.FILTERCHARACTER");
      intent.putExtra("android.intent.action.FILTERCHARACTER", paramString);
      this.mContext.sendBroadcast(intent);
    } 
  }
  
  public void interceptTrimleft(int paramInt) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.TRIMLEFT");
      intent.putExtra("android.intent.action.TRIMLEFT", paramInt);
      this.mContext.sendBroadcast(intent);
    } 
  }
  
  public void interceptTrimright(int paramInt) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.TRIMRIGHT");
      intent.putExtra("android.intent.action.TRIMRIGHT", paramInt);
      this.mContext.sendBroadcast(intent);
    } 
  }
  
  public void intervalSet(int paramInt) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.INTERVALTIME");
      intent.putExtra("android.intent.action.INTERVALTIME", paramInt);
      this.mContext.sendBroadcast(intent);
    } 
  }
  
  public void lightSet(boolean paramBoolean) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.LIGHT");
      intent.putExtra("android.intent.action.LIGHT", paramBoolean);
      this.mContext.sendBroadcast(intent);
    } 
  }
  ...
  public void setOutputMode(int paramInt) {
    if (this.mContext != null) {
      ...
      intent.putExtra("android.intent.action.BARCODEOUTPUT", paramInt);
      this.mContext.sendBroadcast(intent);
    } 
  }
  
  public void timeOutSet(int paramInt) {
    if (this.mContext != null) {
      Intent intent = new Intent("android.intent.action.TIMEOUT");
      intent.putExtra("android.intent.action.TIMEOUT", paramInt);
      this.mContext.sendBroadcast(intent);
    } 
  }
