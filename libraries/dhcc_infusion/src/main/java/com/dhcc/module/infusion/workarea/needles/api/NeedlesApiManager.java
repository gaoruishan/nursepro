...
public class NeedlesApiManager {
     ...
     */
    public static void extractOrd(String oeoreId,String wayNo, String finishWayFlag,final CommonCallBack<CommResult> callBack) {
        NeedlesApiService.extractOrd(oeoreId, wayNo,finishWayFlag,new ServiceCallBack() {
            @Override
            public void onResult(String jsonStr) {
