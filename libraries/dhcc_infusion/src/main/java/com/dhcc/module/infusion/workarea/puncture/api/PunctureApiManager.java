...
public class PunctureApiManager {
     ...
     */
    public static void punctureOrd(String oeoreId, String distantTime, String ifSpeed, String puncturePart, final CommonCallBack<CommResult> callBack) {
        PunctureApiService.punctureOrd(oeoreId, distantTime, ifSpeed, puncturePart, new ServiceCallBack() {
            @Override
            public void onResult(String jsonStr) {
