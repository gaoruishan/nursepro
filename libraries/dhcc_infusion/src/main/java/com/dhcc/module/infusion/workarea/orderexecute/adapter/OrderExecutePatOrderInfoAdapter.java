 ...
 * @date 2018/8/25
 */
public class OrderExecutePatOrderInfoAdapter extends BaseQuickAdapter<OrderExecuteBean.OrdersBean.PatOrdsBean, BaseViewHolder> {
    private int size;

    public OrderExecutePatOrderInfoAdapter(@Nullable List<OrderExecuteBean.OrdersBean.PatOrdsBean> data, int size) {
        super(R.layout.dhcc_item_oepatient_orderinfo, data);
        this.size = size;
    }
