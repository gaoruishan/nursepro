...
import com.dhcc.module.nurse.bloodsugar.bean.ScanGetUserMsgBean;
 ...
 * Time:15:21
 */
public class GetScanPatsBean extends CommResult {
        /**
         * msg : 成功
         * msgcode : 999999
        ...
        private com.dhcc.module.nurse.bloodsugar.bean.ScanGetUserMsgBean.PatInfoBean patInfo;


        public com.dhcc.module.nurse.bloodsugar.bean.ScanGetUserMsgBean.PatInfoBean getPatInfo() {
            return patInfo;
        }

        public void setPatInfo(com.dhcc.module.nurse.bloodsugar.bean.ScanGetUserMsgBean.PatInfoBean patInfo) {
