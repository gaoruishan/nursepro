 ...
 */
public class AccompanySheetAdapter extends BaseQuickAdapter<ConfigSheetBean, BaseViewHolder> {


    public AccompanySheetAdapter(int layoutResId, @Nullable List<ConfigSheetBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ConfigSheetBean item) {
