...
public class HealthEduContentFragment extends BaseNurseFragment {
    ...
    protected void initDatas() {
        ...
        tvName.setText(desc + "");
        CustomSelectView customSelectDate = f(R.id.custom_select_date, CustomSelectView.class);
        if (bean instanceof  EducationListBean.DataBean) {
            ...
            customSelectDate.setSelectTime(HealthEduContentFragment.this.getFragmentManager(), millis, null);
