 ...
 */
public class HealthEduDrugAdapter extends BaseQuickAdapter<EduOrdListBean.OrdListBean, BaseViewHolder> {


    public HealthEduDrugAdapter(int layoutResId, @Nullable List<EduOrdListBean.OrdListBean> data) {
