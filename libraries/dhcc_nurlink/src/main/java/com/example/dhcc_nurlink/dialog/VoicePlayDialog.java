...
import com.example.dhcc_nurlink.Utils.VoicePlayActivity;
 ...
 * Time:14:32
 */
public class VoicePlayDialog extends Dialog implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener{
    ...
    private void initView() {
        ...
        btnBack.setOnClickListener(v ->stop());
    ...
    public onCancelOnclickListener onCancelOnclickListener;

    public void setOnBackListener(onCancelOnclickListener onBackListener){
        this.onCancelOnclickListener = onBackListener;
    }
    ...
    public void init(String url) {
        ...
        //①下载
        DownloadManager.getInstance(context).downloadFile(FileType.TYPE_AUDIO, "111", url, new OnDownloadingListener() {
            @Override
