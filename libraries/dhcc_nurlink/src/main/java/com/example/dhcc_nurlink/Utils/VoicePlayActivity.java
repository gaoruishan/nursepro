...
public class VoicePlayActivity extends Activity implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener {
    private static final String TAG = VoicePlayActivity.class.getSimpleName();
    public MediaPlayer mediaPlayer; // 媒体播放器
    private Timer timer = new Timer(); // 计时器
    private boolean isPrepare = false;
    private SeekBar seekBar;
    private static final String PATH = "http://file.kuyinyun.com/group1/M00/90/B7/rBBGdFPXJNeAM-nhABeMElAM6bY151.mp3";
